...
abstract class BaseMock extends PHPUnitObject
{
    ...
    /**
     * Defined by the sub-class and generated by the ClassGenerator
     *
     * @var string[][]
     * @see \JSiefer\ClassMocker\Generator\ClassGenerator::generate
     */
    protected static $___classMocker_traitMethods = [];
    ...
    public function __call($name, $arguments)
    {
        ...
        $result = $this->__callTraitMethods($name, func_get_args());
        if (next::isNot($result)) {
            return $result;
        }
     ...
     * @return mixed
     */
    private function __callTraitMethods($name, $arguments, $reverse = false)
    {
        $result = next::caller();

        if (!isset(static::$___classMocker_traitMethods[$name])) {
            return $result;
        }

        $methods = static::$___classMocker_traitMethods[$name];
